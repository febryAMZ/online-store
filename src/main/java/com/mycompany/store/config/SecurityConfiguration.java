...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/order-items").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/api/invoices").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/api/shipments").hasAuthority(AuthoritiesConstants.ADMIN)
